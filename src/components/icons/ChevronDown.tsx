...
export function MarketDown(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 16 16" fill="none" aria-hidden="true" {...props}>
      <path
        d="M6.925 14.169c.543.847 1.607.847 2.15 0l6.64-10.352c.688-1.071.052-2.621-1.074-2.621H1.36C.233 1.196-.403 2.746.284 3.817l6.641 10.352Z"
        fill="currentColor"
      />
    </svg>
  );
