...
const ko = {
  ...
  helpGreeting: "안녕하세요 👋", helpQuestion: "무엇을 도와드릴까요?",
  startConversation: "대화 시작하기", replyTime: "보통 몇 시간 이내에 답변합니다.",
  chainDocumentation: "AYXX Chain 문서", allSystemsOperational: "모든 시스템 정상 운영 중",
  statusUpdated: "최근 업데이트", searchHelp: "도움말 검색",
  ...
  helpArticleConnectWallet: "지갑을 연결하고 AYXX Chain에서 거래를 시작하는 방법",
  helpCollections: "5개 컬렉션", helpOnboarding: "시작하기",
  helpOnboardingDescription: "일반, 온보딩, 출금 및 입금", helpOnboardingCount: "문서 12개",
  helpTradingCollection: "거래", helpTradingDescription: "무기한, 주문 유형 및 거래", helpTradingCount: "문서 14개",
  helpDeveloperDocs: "개발자 문서", helpDeveloperDescription: "개발자 및 기술 문서", helpDeveloperCount: "문서 1개",
  helpGovernanceCollection: "거버넌스 및 스테이킹", helpGovernanceDescription: "거버넌스 참여 및 스테이킹", helpGovernanceCount: "문서 6개",
  helpAffiliates: "제휴", helpAffiliatesDescription: "AYXX 제휴 프로그램", helpAffiliatesCount: "문서 4개",
  noHelpResults: "검색 결과가 없습니다.",
  noMessages: "메시지가 없습니다", messagesWillAppear: "팀에서 보낸 메시지가 여기에 표시됩니다.",
  supportTeamCanHelp: "팀에서도 도와드릴 수 있습니다", supportPrompt: "무엇이든 질문하거나 의견을 남겨주세요.",
  supportGreeting: "안녕하세요. 무엇을 도와드릴까요?", justNow: "방금",
  supportOnboard: "소셜 계정으로 가입 및 입금", supportDepositIssue: "입금 또는 출금 문제",
  supportAffiliate: "제휴 프로그램", supportGovernance: "거버넌스 및 스테이킹",
  supportApi: "API 거래", supportBlocked: "차단된 계정", supportOther: "기타",
  supportGuide: "이메일 또는 소셜 로그인으로 가입하는 방법에 대한 안내입니다.",
  supportArticleTitle: "소셜 계정을 통한 가입 및 입금", supportArticleDescription: "이 문서에서는 이메일 또는 소셜 계정을 이용한 가입 방법을 안내합니다.",
  wasHelpful: "도움이 되었나요?", joinedConversation: "상담에 참여했습니다",
  agentReply: "안녕하세요! 상담원입니다. 봇이 소셜 계정을 통한 입금 흐름에 관한 문서를 안내한 것을 확인했습니다. 도움이 되었기를 바랍니다. 궁금한 점이 있으면 알려주세요.",
  messagePlaceholder: "메시지...", expandWindow: "창 확장", downloadTranscript: "대화 내용 다운로드",
  home: "홈", messages: "메시지", helpCenter: "도움말",
  globalChat: "글로벌 채팅", online: "온라인", close: "닫기", minimizeChat: "채팅 최소화", unlockChatWithTrades: "거래를 통해 채팅 잠금을 해제하세요",
  tradeVolume: "30일 거래량", unlockAt: "전 잠금을 해제할 거래량",
  ...
  maintenanceMarginRateTip: "포지션을 유지하기 위해 필요한 최소 마진 비율입니다.",
  initialMarginRateTip: "새 포지션을 개설하기 위해 필요한 초기 마진 비율입니다.",
...
const en: Dictionary = {
  ...
  operational:"Operational",chat:"Chat",helpSupport:"Help & support",
  helpGreeting:"Hi there 👋",helpQuestion:"How can we help?",startConversation:"Start a conversation",
  replyTime:"We typically reply in a few hours",chainDocumentation:"AYXX Chain Documentation",
  allSystemsOperational:"Status: All Systems Operational",statusUpdated:"Updated Jul 28, 00:19 UTC",
  searchHelp:"Search for help",helpArticleTrading:"How to Trade in Isolated Markets using Isolated Margin",
  helpArticleGovernance:"Governance and Staking on Keplr",helpArticleLiquidations:"Liquidations on AYXX Chain",
  helpArticleConnectWallet:"How to Connect Your Wallet and Start Trading on AYXX Chain",
  helpCollections:"5 collections",helpOnboarding:"Onboarding",
  helpOnboardingDescription:"General, Onboarding, Withdrawals and Deposits",helpOnboardingCount:"12 articles",
  helpTradingCollection:"Trading",helpTradingDescription:"Perps, order types, and trading",helpTradingCount:"14 articles",
  helpDeveloperDocs:"Developer Docs",helpDeveloperDescription:"Developers and Technical Docs",helpDeveloperCount:"1 article",
  helpGovernanceCollection:"Governance & Staking",helpGovernanceDescription:"Participating in governance and staking.",helpGovernanceCount:"6 articles",
  helpAffiliates:"Affiliates",helpAffiliatesDescription:"Affiliate with AYXX",helpAffiliatesCount:"4 articles",
  noHelpResults:"No results found.",
  noMessages:"No messages",messagesWillAppear:"Messages from the team will be shown here",
  supportTeamCanHelp:"The team can also help",supportPrompt:"Ask us anything, or share your feedback.",
  supportGreeting:"Hi there, what brings you here today?",justNow:"Just now",
  supportOnboard:"Onboard & Deposit with Socials",supportDepositIssue:"Deposit or withdrawal issue",
  supportAffiliate:"Affiliate Program",supportGovernance:"Governance and Staking",
  supportApi:"API Trading",supportBlocked:"Blocked Accounts",supportOther:"Other",
  supportGuide:"Here is a guide to signing in using email or social login.",
  supportArticleTitle:"Onboarding and Deposit via Socials",supportArticleDescription:"This article walks through signing in using email or social accounts.",
  wasHelpful:"Was this helpful?",joinedConversation:"joined the conversation",
  agentReply:"Hi there! This is Hasmik. I can see that the bot has provided you with the article on the deposit flow via socials. I hope it was helpful. Please let me know if you have any questions.",
  messagePlaceholder:"Message...",expandWindow:"Expand window",downloadTranscript:"Download transcript",
  home:"Home",messages:"Messages",helpCenter:"Help",
  openSourceNotice:"This site uses open-source software.",learnMore:"Learn more",
  globalChat:"Global chat",online:"online",close:"Close",minimizeChat:"Minimize chat",unlockChatWithTrades:"Unlock chat through trading",tradeVolume:"30-day volume",unlockAt:"trading volume to unlock",
  ...
  tickSizeTip:"The smallest amount by which the price can change in this market.",stepSizeTip:"The smallest increment by which an order size can be changed.",maintenanceMarginRateTip:"The minimum margin ratio required to keep a position open.",initialMarginRateTip:"The initial margin ratio required to open a new position.",
...
const overrides: Record<Exclude<Lang, "ko" | "en">, Partial<Dictionary>> = {
  ja: {
    ...
    globalChat:"グローバルチャット",online:"オンライン",close:"閉じる",minimizeChat:"チャットを最小化",unlockChatWithTrades:"取引してチャットを解除",tradeVolume:"30日間の取引量",unlockAt:"解除に必要な取引量",openSourceNotice:"このサイトはオープンソースソフトウェアを使用しています。",
    helpGreeting:"こんにちは 👋",helpQuestion:"どのようにお手伝いできますか？",startConversation:"会話を始める",replyTime:"通常、数時間以内に返信します",chainDocumentation:"AYXX Chain ドキュメント",allSystemsOperational:"ステータス：すべて正常稼働",statusUpdated:"最終更新",searchHelp:"ヘルプを検索",helpArticleTrading:"分離市場で分離マージンを使って取引する方法",helpArticleGovernance:"Keplrでのガバナンスとステーキング",helpArticleLiquidations:"AYXX Chainの清算",helpArticleConnectWallet:"ウォレットを接続してAYXX Chainで取引を始める方法",home:"ホーム",messages:"メッセージ",helpCenter:"ヘルプ",
    helpCollections:"5件のコレクション",helpOnboarding:"オンボーディング",helpOnboardingDescription:"一般、オンボーディング、出金、入金",helpOnboardingCount:"12件の記事",helpTradingCollection:"取引",helpTradingDescription:"無期限、注文タイプ、取引",helpTradingCount:"14件の記事",helpDeveloperDocs:"開発者ドキュメント",helpDeveloperDescription:"開発者向け技術ドキュメント",helpDeveloperCount:"1件の記事",helpGovernanceCollection:"ガバナンスとステーキング",helpGovernanceDescription:"ガバナンスへの参加とステーキング",helpGovernanceCount:"6件の記事",helpAffiliates:"アフィリエイト",helpAffiliatesDescription:"AYXXアフィリエイトプログラム",helpAffiliatesCount:"4件の記事",noHelpResults:"検索結果がありません。",
    noMessages:"メッセージはありません",messagesWillAppear:"チームからのメッセージがここに表示されます",supportTeamCanHelp:"チームもサポートできます",supportPrompt:"何でもご質問またはフィードバックをお寄せください。",supportGreeting:"こんにちは。今日はどのようなご用件ですか？",justNow:"たった今",supportOnboard:"ソーシャルで登録・入金",supportDepositIssue:"入金または出金の問題",supportAffiliate:"アフィリエイトプログラム",supportGovernance:"ガバナンスとステーキング",supportApi:"API取引",supportBlocked:"ブロックされたアカウント",supportOther:"その他",
    supportGuide:"メールまたはソーシャルログインでサインインする方法のガイドです。",supportArticleTitle:"ソーシャル経由の登録と入金",supportArticleDescription:"メールまたはソーシャルアカウントを使用した登録方法を説明します。",wasHelpful:"役に立ちましたか？",joinedConversation:"が会話に参加しました",agentReply:"こんにちは、Hasmikです。ボットがソーシャル経由の入金フローに関する記事をご案内したことを確認しました。お役に立てれば幸いです。ご質問があればお知らせください。",messagePlaceholder:"メッセージ...",expandWindow:"ウィンドウを拡大",downloadTranscript:"会話をダウンロード",
  },
  zh: {
    ...
    globalChat:"全球聊天",online:"在线",close:"关闭",minimizeChat:"最小化聊天",unlockChatWithTrades:"通过交易解锁聊天",tradeVolume:"30天交易量",unlockAt:"解锁所需交易量",openSourceNotice:"本网站使用开源软件。",
    helpGreeting:"您好 👋",helpQuestion:"我们能为您提供什么帮助？",startConversation:"开始对话",replyTime:"我们通常会在几小时内回复",chainDocumentation:"AYXX Chain 文档",allSystemsOperational:"状态：所有系统运行正常",statusUpdated:"最近更新",searchHelp:"搜索帮助",helpArticleTrading:"如何在逐仓市场使用逐仓保证金交易",helpArticleGovernance:"在Keplr上参与治理与质押",helpArticleLiquidations:"AYXX Chain上的清算",helpArticleConnectWallet:"如何连接钱包并开始在AYXX Chain上交易",home:"首页",messages:"消息",helpCenter:"帮助",
    helpCollections:"5个集合",helpOnboarding:"入门",helpOnboardingDescription:"常规、入门、提现和充值",helpOnboardingCount:"12篇文章",helpTradingCollection:"交易",helpTradingDescription:"永续合约、订单类型和交易",helpTradingCount:"14篇文章",helpDeveloperDocs:"开发者文档",helpDeveloperDescription:"开发者和技术文档",helpDeveloperCount:"1篇文章",helpGovernanceCollection:"治理与质押",helpGovernanceDescription:"参与治理和质押",helpGovernanceCount:"6篇文章",helpAffiliates:"联盟计划",helpAffiliatesDescription:"AYXX联盟计划",helpAffiliatesCount:"4篇文章",noHelpResults:"未找到搜索结果。",
    noMessages:"暂无消息",messagesWillAppear:"团队发送的消息将显示在这里",supportTeamCanHelp:"团队也可以提供帮助",supportPrompt:"欢迎提问或分享您的反馈。",supportGreeting:"您好，今天有什么可以帮您？",justNow:"刚刚",supportOnboard:"使用社交账户注册和充值",supportDepositIssue:"充值或提现问题",supportAffiliate:"联盟计划",supportGovernance:"治理与质押",supportApi:"API交易",supportBlocked:"被封锁的账户",supportOther:"其他",
    supportGuide:"这是使用电子邮件或社交登录进行注册的指南。",supportArticleTitle:"通过社交账户注册和充值",supportArticleDescription:"本文介绍如何使用电子邮件或社交账户进行注册。",wasHelpful:"这对您有帮助吗？",joinedConversation:"加入了对话",agentReply:"您好！我是Hasmik。我看到机器人已经向您提供了有关通过社交账户充值流程的文章。希望对您有所帮助。如有任何问题，请告诉我。",messagePlaceholder:"输入消息...",expandWindow:"展开窗口",downloadTranscript:"下载对话记录",
  },
  vi: {
    ...
    globalChat:"Trò chuyện toàn cầu",online:"trực tuyến",close:"Đóng",minimizeChat:"Thu nhỏ trò chuyện",unlockChatWithTrades:"Giao dịch để mở khóa trò chuyện",tradeVolume:"Khối lượng giao dịch 30 ngày",unlockAt:"Khối lượng cần để mở khóa",openSourceNotice:"Trang web này sử dụng phần mềm mã nguồn mở.",
    helpGreeting:"Xin chào 👋",helpQuestion:"Chúng tôi có thể giúp gì cho bạn?",startConversation:"Bắt đầu cuộc trò chuyện",replyTime:"Chúng tôi thường trả lời trong vài giờ",chainDocumentation:"Tài liệu AYXX Chain",allSystemsOperational:"Trạng thái: Tất cả hệ thống hoạt động bình thường",statusUpdated:"Cập nhật gần nhất",searchHelp:"Tìm kiếm trợ giúp",helpArticleTrading:"Cách giao dịch trên thị trường ký quỹ cô lập",helpArticleGovernance:"Quản trị và staking trên Keplr",helpArticleLiquidations:"Thanh lý trên AYXX Chain",helpArticleConnectWallet:"Cách kết nối ví và bắt đầu giao dịch trên AYXX Chain",home:"Trang chủ",messages:"Tin nhắn",helpCenter:"Trợ giúp",
    helpCollections:"5 bộ sưu tập",helpOnboarding:"Bắt đầu",helpOnboardingDescription:"Chung, bắt đầu, rút và nạp tiền",helpOnboardingCount:"12 bài viết",helpTradingCollection:"Giao dịch",helpTradingDescription:"Hợp đồng vĩnh viễn, loại lệnh và giao dịch",helpTradingCount:"14 bài viết",helpDeveloperDocs:"Tài liệu nhà phát triển",helpDeveloperDescription:"Tài liệu kỹ thuật và nhà phát triển",helpDeveloperCount:"1 bài viết",helpGovernanceCollection:"Quản trị & Staking",helpGovernanceDescription:"Tham gia quản trị và staking",helpGovernanceCount:"6 bài viết",helpAffiliates:"Đối tác liên kết",helpAffiliatesDescription:"Chương trình liên kết AYXX",helpAffiliatesCount:"4 bài viết",noHelpResults:"Không tìm thấy kết quả.",
    noMessages:"Không có tin nhắn",messagesWillAppear:"Tin nhắn từ đội ngũ sẽ hiển thị tại đây",supportTeamCanHelp:"Đội ngũ cũng có thể hỗ trợ",supportPrompt:"Hãy hỏi bất cứ điều gì hoặc chia sẻ phản hồi.",supportGreeting:"Xin chào, hôm nay bạn cần hỗ trợ gì?",justNow:"Vừa xong",supportOnboard:"Đăng ký và nạp tiền bằng mạng xã hội",supportDepositIssue:"Vấn đề nạp hoặc rút tiền",supportAffiliate:"Chương trình liên kết",supportGovernance:"Quản trị và Staking",supportApi:"Giao dịch API",supportBlocked:"Tài khoản bị chặn",supportOther:"Khác",
    supportGuide:"Đây là hướng dẫn đăng nhập bằng email hoặc tài khoản mạng xã hội.",supportArticleTitle:"Đăng ký và nạp tiền qua mạng xã hội",supportArticleDescription:"Bài viết này hướng dẫn đăng nhập bằng email hoặc tài khoản mạng xã hội.",wasHelpful:"Nội dung này có hữu ích không?",joinedConversation:"đã tham gia cuộc trò chuyện",agentReply:"Xin chào! Tôi là Hasmik. Tôi thấy bot đã cung cấp bài viết về quy trình nạp tiền qua mạng xã hội. Hy vọng bài viết hữu ích. Hãy cho tôi biết nếu bạn có câu hỏi.",messagePlaceholder:"Tin nhắn...",expandWindow:"Mở rộng cửa sổ",downloadTranscript:"Tải xuống cuộc trò chuyện",
  },
  fr: {
    ...
    globalChat:"Chat mondial",online:"en ligne",close:"Fermer",minimizeChat:"Réduire le chat",unlockChatWithTrades:"Tradez pour déverrouiller le chat",tradeVolume:"Volume de trading sur 30 jours",unlockAt:"Volume requis pour déverrouiller",openSourceNotice:"Ce site utilise des logiciels open source.",
    helpGreeting:"Bonjour 👋",helpQuestion:"Comment pouvons-nous vous aider ?",startConversation:"Démarrer une conversation",replyTime:"Nous répondons généralement sous quelques heures",chainDocumentation:"Documentation AYXX Chain",allSystemsOperational:"Statut : tous les systèmes sont opérationnels",statusUpdated:"Dernière mise à jour",searchHelp:"Rechercher de l’aide",helpArticleTrading:"Comment trader avec une marge isolée",helpArticleGovernance:"Gouvernance et staking sur Keplr",helpArticleLiquidations:"Liquidations sur AYXX Chain",helpArticleConnectWallet:"Comment connecter votre portefeuille et commencer à trader sur AYXX Chain",home:"Accueil",messages:"Messages",helpCenter:"Aide",
    helpCollections:"5 collections",helpOnboarding:"Prise en main",helpOnboardingDescription:"Général, prise en main, retraits et dépôts",helpOnboardingCount:"12 articles",helpTradingCollection:"Trading",helpTradingDescription:"Contrats perpétuels, types d’ordres et trading",helpTradingCount:"14 articles",helpDeveloperDocs:"Documentation développeur",helpDeveloperDescription:"Documentation technique et développeur",helpDeveloperCount:"1 article",helpGovernanceCollection:"Gouvernance et staking",helpGovernanceDescription:"Participation à la gouvernance et au staking",helpGovernanceCount:"6 articles",helpAffiliates:"Affiliation",helpAffiliatesDescription:"Programme d’affiliation AYXX",helpAffiliatesCount:"4 articles",noHelpResults:"Aucun résultat trouvé.",
    noMessages:"Aucun message",messagesWillAppear:"Les messages de l’équipe apparaîtront ici",supportTeamCanHelp:"L’équipe peut également vous aider",supportPrompt:"Posez-nous vos questions ou partagez vos commentaires.",supportGreeting:"Bonjour, que pouvons-nous faire pour vous aujourd’hui ?",justNow:"À l’instant",supportOnboard:"Inscription et dépôt via les réseaux sociaux",supportDepositIssue:"Problème de dépôt ou de retrait",supportAffiliate:"Programme d’affiliation",supportGovernance:"Gouvernance et staking",supportApi:"Trading API",supportBlocked:"Comptes bloqués",supportOther:"Autre",
    supportGuide:"Voici un guide pour vous connecter par e-mail ou via un compte social.",supportArticleTitle:"Inscription et dépôt via les réseaux sociaux",supportArticleDescription:"Cet article explique comment s’inscrire par e-mail ou via un compte social.",wasHelpful:"Cela vous a-t-il été utile ?",joinedConversation:"a rejoint la conversation",agentReply:"Bonjour ! Je suis Hasmik. Je vois que le bot vous a fourni l’article sur le dépôt via les réseaux sociaux. J’espère qu’il vous a été utile. N’hésitez pas à me poser vos questions.",messagePlaceholder:"Message...",expandWindow:"Agrandir la fenêtre",downloadTranscript:"Télécharger la conversation",
  },
};
